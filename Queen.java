...
public class Queen implements Piece {
    ...
    public boolean checkMove(int startx, int starty, int endx, int endy) {
        ...
        if (Math.abs(i) == Math.abs(j)) {
            ...
            while (true) {
                if (i == 0 && j > 0 && Game.logicalGame.get(startx, starty - a) == null)
                    say = 1;
                else if (i == 0 && j < 0 && Game.logicalGame.get(startx, starty + a) == null)
                    say = 2;
                else if (j == 0 && i < 0 && Game.logicalGame.get(startx + a, starty) == null)
                    say = 3;
                else if (j == 0 && i > 0 && Game.logicalGame.get(startx - a, starty) == null)
                    say = 4;
                else {
